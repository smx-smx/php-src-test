...
PHP_ARG_WITH([info],,
  [AS_HELP_STRING([--without-info],
    [Exclude phpinfo() support])],
    [yes])

if test "$PHP_INFO" != "no"; then
  info_sources="credits.c info.c"
fi

if test "$PHP_DATE" != "no"; then
  date_sources="head.c mail.c"
fi

PHP_ARG_WITH([html],,
  [AS_HELP_STRING([--without-html],
    [Exclude html functions])],
    [yes])
if test "$PHP_HTML" != "no"; then
  html_sources="html.c"
fi
...
PHP_NEW_EXTENSION(standard, array.c base64.c basic_functions.c browscap.c crc32.c crypt.c \
                            ...
                            flock_compat.c formatted_print.c fsock.c $html_sources image.c \
                            $info_sources iptc.c lcg.c link.c $date_sources math.c md5.c metaphone.c \
                            ...
                            http_fopen_wrapper.c php_fopen_wrapper.c css.c \
